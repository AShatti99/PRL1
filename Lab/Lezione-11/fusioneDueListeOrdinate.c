...
inserito in lista), e le inserisca in due liste distinte. Le liste possono contenere duplicati. 
Scrivere una funzione che, prese in input le due liste, crei una terza lista di numeri interi ordinata, 
ottenuta mediante la “fusione” delle prime due. 
Si stampi il contenuto della lista ottenuta.
*/
